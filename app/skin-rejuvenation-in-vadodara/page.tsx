...
export const metadata: Metadata = {
  title: "Expert Skin Rejuvenation Solutions in Vadodara | Prime One Clinic",
  description: "Skin Rejuvenation - Advanced solutions by board-certified specialists. ✓ Safe & effective ✓ Personalized care ✓ 4.9★ rated. Book today!",
  keywords: "skin, rejuvenation vadodara, skin rejuvenation near me, best skin rejuvenation vadodara",
  alternates: {
    canonical: "https://skinhairvadodara.in/skin-rejuvenation-in-vadodara",
  },
  openGraph: {
    title: "Expert Skin Rejuvenation Solutions in Vadodara | Prime One Hair & Skin Clinic",
    description: "Skin Rejuvenation - Advanced solutions by board-certified specialists. ✓ Safe & effective ✓ Personalized care ✓ 4.9★ rated. Book today!",
    url: "https://skinhairvadodara.in/skin-rejuvenation-in-vadodara",
...
export default function SkinRejuvenationPage() {
  const content = {
    heroTitle: "Expert Skin Rejuvenation Solutions in Vadodara",
    heroSubtitle: "Your Journey to Better Skin & Hair Starts Here",
    
    introContent: `Uneven skin tone and pigmentation issues are among the most common concerns we see at our Vadodara clinic. Skin Rejuvenation requires both expertise and patience — there are no instant fixes, but with the right approach, significant improvement is absolutely achievable.
...
Our pigmentation protocols at Prime One Hair & Skin Clinic combine multiple modalities for comprehensive results. This typically includes medical-grade topical treatments, chemical peels customized to your skin type, laser or light-based therapies, and strict sun protection guidance. We also address internal factors through nutritional recommendations and hormonal assessment when relevant.`,
    ...
    faqItems: [
          {
                "question": "Is skin rejuvenation safe for dark skin?",
          ...
          {
                "question": "How long does skin rejuvenation take?",
    ...
    ctaText: "Get Expert Skin Rejuvenation Today",
    ctaDescription: "Professional skin rejuvenation doesn't have to be complicated or expensive. Book your consultation and discover your options today.",
  };

  return (
    <KeywordPageTemplate
      business={business}
      keyword="skin-rejuvenation-in-vadodara"
      content={content}
    />
  );
}
