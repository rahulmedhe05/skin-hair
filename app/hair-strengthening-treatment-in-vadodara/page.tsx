...
export const metadata: Metadata = {
  title: "Leading Hair Strengthening Treatment in Vadodara | Prime One Clinic",
  description: "Get the best hair strengthening treatment at Prime One Vadodara. ✓ MD dermatologists ✓ US FDA devices ✓ 10000+ happy patients. Consultation ₹500.",
  keywords: "hair, strengthening, treatment vadodara, hair strengthening treatment near me, best hair strengthening vadodara",
  alternates: {
    canonical: "https://skinhairvadodara.in/hair-strengthening-treatment-in-vadodara",
  },
  openGraph: {
    title: "Leading Hair Strengthening Treatment in Vadodara | Prime One Hair & Skin Clinic",
    description: "Get the best hair strengthening treatment at Prime One Vadodara. ✓ MD dermatologists ✓ US FDA devices ✓ 10000+ happy patients. Consultation ₹500.",
    url: "https://skinhairvadodara.in/hair-strengthening-treatment-in-vadodara",
...
export default function HairStrengtheningTreatmentPage() {
  const content = {
    heroTitle: "Leading Hair Strengthening Treatment in Vadodara",
    heroSubtitle: "Clinically Proven Results with Hair Strengthening Treatment",
    
    introContent: `Hair thinning and loss affect millions of people, yet most suffer in silence or waste money on products that don't work. If you're searching for hair strengthening treatment, you need to understand that effective treatment starts with proper diagnosis.
...
Our treatment protocols combine multiple evidence-based approaches for the best results. Depending on your diagnosis, this might include medical therapy, PRP or GFC treatments, low-level laser therapy, nutritional supplementation, and lifestyle modifications. We track progress through regular follow-ups and digital photography so you can see measurable improvement.`,
    ...
    faqItems: [
          ...
          {
                "question": "How effective is hair strengthening treatment?",
    ...
    ctaText: "Don't Wait — Book Your Hair Strengthening Treatment Now",
    ctaDescription: "Professional hair strengthening treatment doesn't have to be complicated or expensive. Book your consultation and discover your options today.",
  };

  return (
    <KeywordPageTemplate
      business={business}
      keyword="hair-strengthening-treatment-in-vadodara"
      content={content}
    />
  );
}
