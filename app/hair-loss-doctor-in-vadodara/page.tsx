...
export const metadata: Metadata = {
  title: "Leading Hair Loss Doctor in Vadodara | Prime One Clinic",
  description: "✅ Hair Loss Doctor by MD dermatologists at Prime One Clinic ✓ Proven results ✓ 10,000+ patients ✓ US FDA approved. Book consultation today!",
  keywords: "hair, loss, doctor vadodara, hair loss doctor near me, best hair loss vadodara",
  alternates: {
    canonical: "https://skinhairvadodara.in/hair-loss-doctor-in-vadodara",
  },
  openGraph: {
    title: "Leading Hair Loss Doctor in Vadodara | Prime One Hair & Skin Clinic",
    description: "✅ Hair Loss Doctor by MD dermatologists at Prime One Clinic ✓ Proven results ✓ 10,000+ patients ✓ US FDA approved. Book consultation today!",
    url: "https://skinhairvadodara.in/hair-loss-doctor-in-vadodara",
...
export default function HairLossDoctorPage() {
  const content = {
    heroTitle: "Leading Hair Loss Doctor in Vadodara",
    heroSubtitle: "Clinically Proven Results with Hair Loss Doctor",
    
    introContent: `Hair thinning and loss affect millions of people, yet most suffer in silence or waste money on products that don't work. If you're searching for hair loss doctor, you need to understand that effective treatment starts with proper diagnosis.
...
Our treatment protocols combine multiple evidence-based approaches for the best results. Depending on your diagnosis, this might include medical therapy, PRP or GFC treatments, low-level laser therapy, nutritional supplementation, and lifestyle modifications. We track progress through regular follow-ups and digital photography so you can see measurable improvement.`,
    ...
    faqItems: [
          ...
          {
                "question": "How effective is hair loss doctor?",
    ...
    ctaText: "Ready to Start Your Hair Loss Doctor Journey?",
    ctaDescription: "Professional hair loss doctor doesn't have to be complicated or expensive. Book your consultation and discover your options today.",
  };

  return (
    <KeywordPageTemplate
      business={business}
      keyword="hair-loss-doctor-in-vadodara"
      content={content}
    />
  );
}
