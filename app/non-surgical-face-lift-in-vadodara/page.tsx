...
export const metadata: Metadata = {
  title: "Non Surgical Face Lift Experts in Vadodara | Prime One Clinic",
  description: "Looking for non surgical face lift? Prime One Clinic offers expert care with proven results. ✓ 15+ years experience ✓ Modern technology. Call now!",
  keywords: "non, surgical, face, lift vadodara, non surgical face near me, best non surgical vadodara",
  alternates: {
    canonical: "https://skinhairvadodara.in/non-surgical-face-lift-in-vadodara",
  },
  openGraph: {
    title: "Non Surgical Face Lift Experts in Vadodara | Prime One Hair & Skin Clinic",
    description: "Looking for non surgical face lift? Prime One Clinic offers expert care with proven results. ✓ 15+ years experience ✓ Modern technology. Call now!",
    url: "https://skinhairvadodara.in/non-surgical-face-lift-in-vadodara",
...
export default function NonSurgicalFaceLiftPage() {
  const content = {
    heroTitle: "Non Surgical Face Lift Experts in Vadodara",
    heroSubtitle: "Transform Your Appearance with Non Surgical Face Lift",
    
    introContent: `Aging is natural, but how you age is largely within your control. Non Surgical Face Lift at Prime One Hair & Skin Clinic focuses on natural-looking rejuvenation that enhances your features rather than changing them.
...
We believe in a conservative, buildable approach. Starting subtle and adding more as needed always produces better results than doing too much at once. Our patients consistently tell us that friends notice they look refreshed and rested — but can't pinpoint exactly what changed. That's the mark of truly skilled aesthetic work.`,
    ...
    faqItems: [
          {
                "question": "How many sessions of non surgical face lift are needed?",
                "answer": "The number of sessions depends on your specific condition, its severity, and your treatment goals. We provide a clear treatment plan with expected timeline during consultation."
          },
          {
                "question": "How much does non surgical face lift cost in Vadodara?",
                "answer": "Non Surgical Face Lift costs vary based on the specific treatment required, number of sessions, and individual factors. We provide transparent pricing during consultation with no hidden charges."
          },
          {
                "question": "Is non surgical face lift safe?",
                "answer": "When performed by qualified dermatologists using approved equipment and products, non surgical face lift is safe and effective. We follow strict safety protocols and discuss all potential risks beforehand."
          },
          {
                "question": "Why should I choose Prime One for non surgical face lift?",
                "answer": "Our clinic offers board-certified specialists, US FDA-approved equipment, personalized treatment plans, and a proven track record of 10,000+ satisfied patients in Vadodara."
          },
          {
                "question": "What is non surgical face lift?",
                "answer": "Non Surgical Face Lift involves specialized medical procedures performed by qualified dermatologists to address your specific concerns. We use evidence-based approaches tailored to each patient's needs."
          }
    ],

    ctaText: "Your Non Surgical Face Lift Consultation Awaits",
  ...
  return (
    <KeywordPageTemplate
      business={business}
      keyword="non-surgical-face-lift-in-vadodara"
      content={content}
    />
  );
}
