...
export const metadata: Metadata = {
  title: "Best Severe Acne Treatment in Vadodara | Prime One Clinic",
  description: "Looking for severe acne treatment? Prime One Clinic offers expert care with proven results. ✓ 15+ years experience ✓ Modern technology. Call now!",
  keywords: "severe, acne, treatment vadodara, severe acne treatment near me, best severe acne vadodara",
  alternates: {
    canonical: "https://skinhairvadodara.in/severe-acne-treatment-in-vadodara",
  },
  openGraph: {
    title: "Best Severe Acne Treatment in Vadodara | Prime One Hair & Skin Clinic",
    description: "Looking for severe acne treatment? Prime One Clinic offers expert care with proven results. ✓ 15+ years experience ✓ Modern technology. Call now!",
    url: "https://skinhairvadodara.in/severe-acne-treatment-in-vadodara",
...
export default function SevereAcneTreatmentPage() {
  const content = {
    heroTitle: "Best Severe Acne Treatment in Vadodara",
    heroSubtitle: "Evidence-Based Severe Acne Treatment That Actually Works",
    
    introContent: `Dealing with acne goes beyond the surface — it affects confidence, social interactions, and emotional well-being. If you're looking for severe acne treatment, you deserve a treatment approach based on medical science, not marketing promises.
...
Our treatment success rate exceeds 90% because we take a systematic approach. We combine prescription-strength topical treatments, oral medications when necessary, and clinical procedures like chemical peels, LED therapy, or laser treatments. We also address the psychological impact of acne and provide realistic timelines so you know exactly what to expect.`,
    ...
    faqItems: [
          {
                "question": "Is severe acne treatment safe for sensitive skin?",
          ...
          {
                "question": "How long does severe acne treatment take to work?",
    ...
    ctaText: "Your Severe Acne Treatment Consultation Awaits",
    ctaDescription: "Stop waiting and start seeing results. Book a consultation with our specialist for personalized severe acne treatment that actually works.",
  };

  return (
    <KeywordPageTemplate
      business={business}
      keyword="severe-acne-treatment-in-vadodara"
      content={content}
    />
  );
}
