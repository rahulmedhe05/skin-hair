...
export const metadata: Metadata = {
  title: "Non Surgical Nose Job Experts in Vadodara | Prime One Clinic",
  description: "Non Surgical Nose Job - Advanced solutions by board-certified specialists. ✓ Safe & effective ✓ Personalized care ✓ 4.9★ rated. Book today!",
  keywords: "non, surgical, nose, job vadodara, non surgical nose near me, best non surgical vadodara",
  alternates: {
    canonical: "https://skinhairvadodara.in/non-surgical-nose-job-in-vadodara",
  },
  openGraph: {
    title: "Non Surgical Nose Job Experts in Vadodara | Prime One Hair & Skin Clinic",
    description: "Non Surgical Nose Job - Advanced solutions by board-certified specialists. ✓ Safe & effective ✓ Personalized care ✓ 4.9★ rated. Book today!",
    url: "https://skinhairvadodara.in/non-surgical-nose-job-in-vadodara",
...
export default function NonSurgicalNoseJobPage() {
  const content = {
    heroTitle: "Non Surgical Nose Job Experts in Vadodara",
    heroSubtitle: "Transform Your Appearance with Non Surgical Nose Job",
    
    introContent: `Aging is natural, but how you age is largely within your control. Non Surgical Nose Job at Prime One Hair & Skin Clinic focuses on natural-looking rejuvenation that enhances your features rather than changing them.
...
We believe in a conservative, buildable approach. Starting subtle and adding more as needed always produces better results than doing too much at once. Our patients consistently tell us that friends notice they look refreshed and rested — but can't pinpoint exactly what changed. That's the mark of truly skilled aesthetic work.`,
    ...
    faqItems: [
          {
                ...
                "answer": "When performed by qualified dermatologists using approved equipment and products, non surgical nose job is safe and effective. We follow strict safety protocols and discuss all potential risks beforehand."
          },
          {
                "question": "What is non surgical nose job?",
                "answer": "Non Surgical Nose Job involves specialized medical procedures performed by qualified dermatologists to address your specific concerns. We use evidence-based approaches tailored to each patient's needs."
          },
          {
                "question": "How much does non surgical nose job cost in Vadodara?",
                "answer": "Non Surgical Nose Job costs vary based on the specific treatment required, number of sessions, and individual factors. We provide transparent pricing during consultation with no hidden charges."
          },
          {
                "question": "How many sessions of non surgical nose job are needed?",
                "answer": "The number of sessions depends on your specific condition, its severity, and your treatment goals. We provide a clear treatment plan with expected timeline during consultation."
          },
          {
                "question": "Why should I choose Prime One for non surgical nose job?",
                "answer": "Our clinic offers board-certified specialists, US FDA-approved equipment, personalized treatment plans, and a proven track record of 10,000+ satisfied patients in Vadodara."
          }
    ],

    ctaText: "Get Expert Non Surgical Nose Job Today",
  ...
  return (
    <KeywordPageTemplate
      business={business}
      keyword="non-surgical-nose-job-in-vadodara"
      content={content}
    />
  );
}
