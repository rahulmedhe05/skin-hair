...
export const metadata: Metadata = {
  title: "Professional Fairness Treatment in Vadodara | Prime One Clinic",
  description: "🏆 Best fairness treatment at Prime One Hair & Skin Clinic Vadodara ✓ Expert doctors ✓ Latest technology ✓ Affordable prices. Call now!",
  keywords: "fairness, treatment vadodara, fairness treatment near me, best fairness treatment vadodara",
  alternates: {
    canonical: "https://skinhairvadodara.in/fairness-treatment-in-vadodara",
  },
  openGraph: {
    title: "Professional Fairness Treatment in Vadodara | Prime One Hair & Skin Clinic",
    description: "🏆 Best fairness treatment at Prime One Hair & Skin Clinic Vadodara ✓ Expert doctors ✓ Latest technology ✓ Affordable prices. Call now!",
    url: "https://skinhairvadodara.in/fairness-treatment-in-vadodara",
...
export default function FairnessTreatmentPage() {
  const content = {
    heroTitle: "Professional Fairness Treatment in Vadodara",
    heroSubtitle: "Personalized Fairness Treatment for Lasting Results",
    
    introContent: `Uneven skin tone and pigmentation issues are among the most common concerns we see at our Vadodara clinic. Fairness Treatment requires both expertise and patience — there are no instant fixes, but with the right approach, significant improvement is absolutely achievable.
...
Our pigmentation protocols at Prime One Hair & Skin Clinic combine multiple modalities for comprehensive results. This typically includes medical-grade topical treatments, chemical peels customized to your skin type, laser or light-based therapies, and strict sun protection guidance. We also address internal factors through nutritional recommendations and hormonal assessment when relevant.`,
    ...
    faqItems: [
          ...
          {
                "question": "How long does fairness treatment take?",
          ...
          {
                "question": "Is fairness treatment safe for dark skin?",
    ...
    ctaText: "Take the First Step Toward Fairness Treatment",
  ...
  return (
    <KeywordPageTemplate
      business={business}
      keyword="fairness-treatment-in-vadodara"
      content={content}
    />
  );
}
