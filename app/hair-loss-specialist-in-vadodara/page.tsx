...
export const metadata: Metadata = {
  title: "Professional Hair Loss Specialist in Vadodara | Prime One Clinic",
  description: "Get the best hair loss specialist at Prime One Vadodara. ✓ MD dermatologists ✓ US FDA devices ✓ 10000+ happy patients. Consultation ₹500.",
  keywords: "hair, loss, specialist vadodara, hair loss specialist near me, best hair loss vadodara",
  alternates: {
    canonical: "https://skinhairvadodara.in/hair-loss-specialist-in-vadodara",
  },
  openGraph: {
    title: "Professional Hair Loss Specialist in Vadodara | Prime One Hair & Skin Clinic",
    description: "Get the best hair loss specialist at Prime One Vadodara. ✓ MD dermatologists ✓ US FDA devices ✓ 10000+ happy patients. Consultation ₹500.",
    url: "https://skinhairvadodara.in/hair-loss-specialist-in-vadodara",
...
export default function HairLossSpecialistPage() {
  const content = {
    heroTitle: "Professional Hair Loss Specialist in Vadodara",
    heroSubtitle: "Personalized Hair Loss Specialist for Lasting Results",
    
    introContent: `Hair thinning and loss affect millions of people, yet most suffer in silence or waste money on products that don't work. If you're searching for hair loss specialist, you need to understand that effective treatment starts with proper diagnosis.
...
Our treatment protocols combine multiple evidence-based approaches for the best results. Depending on your diagnosis, this might include medical therapy, PRP or GFC treatments, low-level laser therapy, nutritional supplementation, and lifestyle modifications. We track progress through regular follow-ups and digital photography so you can see measurable improvement.`,
    ...
    faqItems: [
          ...
          {
                "question": "How effective is hair loss specialist?",
    ...
    ctaText: "Don't Wait — Book Your Hair Loss Specialist Now",
  ...
  return (
    <KeywordPageTemplate
      business={business}
      keyword="hair-loss-specialist-in-vadodara"
      content={content}
    />
  );
}
