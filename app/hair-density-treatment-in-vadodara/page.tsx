...
export const metadata: Metadata = {
  title: "Leading Hair Density Treatment in Vadodara | Prime One Clinic",
  description: "🏆 Best hair density treatment at Prime One Hair & Skin Clinic Vadodara ✓ Expert doctors ✓ Latest technology ✓ Affordable prices. Call now!",
  keywords: "hair, density, treatment vadodara, hair density treatment near me, best hair density vadodara",
  alternates: {
    canonical: "https://skinhairvadodara.in/hair-density-treatment-in-vadodara",
  },
  openGraph: {
    title: "Leading Hair Density Treatment in Vadodara | Prime One Hair & Skin Clinic",
    description: "🏆 Best hair density treatment at Prime One Hair & Skin Clinic Vadodara ✓ Expert doctors ✓ Latest technology ✓ Affordable prices. Call now!",
    url: "https://skinhairvadodara.in/hair-density-treatment-in-vadodara",
...
export default function HairDensityTreatmentPage() {
  const content = {
    heroTitle: "Leading Hair Density Treatment in Vadodara",
    heroSubtitle: "Clinically Proven Results with Hair Density Treatment",
    
    introContent: `Hair thinning and loss affect millions of people, yet most suffer in silence or waste money on products that don't work. If you're searching for hair density treatment, you need to understand that effective treatment starts with proper diagnosis.
...
Our treatment protocols combine multiple evidence-based approaches for the best results. Depending on your diagnosis, this might include medical therapy, PRP or GFC treatments, low-level laser therapy, nutritional supplementation, and lifestyle modifications. We track progress through regular follow-ups and digital photography so you can see measurable improvement.`,
    ...
    faqItems: [
          ...
          {
                "question": "How effective is hair density treatment?",
    ...
    ctaText: "Take the First Step Toward Hair Density Treatment",
    ctaDescription: "Professional hair density treatment doesn't have to be complicated or expensive. Book your consultation and discover your options today.",
  };

  return (
    <KeywordPageTemplate
      business={business}
      keyword="hair-density-treatment-in-vadodara"
      content={content}
    />
  );
}
