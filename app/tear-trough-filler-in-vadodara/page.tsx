...
export const metadata: Metadata = {
  title: "Premium Tear Trough Filler in Vadodara | Prime One Clinic",
  description: "Tear Trough Filler - Advanced solutions by board-certified specialists. ✓ Safe & effective ✓ Personalized care ✓ 4.9★ rated. Book today!",
  keywords: "tear, trough, filler vadodara, tear trough filler near me, best tear trough vadodara",
  alternates: {
    canonical: "https://skinhairvadodara.in/tear-trough-filler-in-vadodara",
  },
  openGraph: {
    title: "Premium Tear Trough Filler in Vadodara | Prime One Hair & Skin Clinic",
    description: "Tear Trough Filler - Advanced solutions by board-certified specialists. ✓ Safe & effective ✓ Personalized care ✓ 4.9★ rated. Book today!",
    url: "https://skinhairvadodara.in/tear-trough-filler-in-vadodara",
...
export default function TearTroughFillerPage() {
  const content = {
    heroTitle: "Premium Tear Trough Filler in Vadodara",
    heroSubtitle: "Safe, Effective & Affordable Tear Trough Filler",
    
    introContent: `Aging is natural, but how you age is largely within your control. Tear Trough Filler at Prime One Hair & Skin Clinic focuses on natural-looking rejuvenation that enhances your features rather than changing them.
    ...
    faqItems: [
          {
                ...
                "answer": "When performed by qualified dermatologists using approved equipment and products, tear trough filler is safe and effective. We follow strict safety protocols and discuss all potential risks beforehand."
          },
          {
                "question": "What is tear trough filler?",
                "answer": "Tear Trough Filler involves specialized medical procedures performed by qualified dermatologists to address your specific concerns. We use evidence-based approaches tailored to each patient's needs."
          },
          {
                "question": "How much does tear trough filler cost in Vadodara?",
                "answer": "Tear Trough Filler costs vary based on the specific treatment required, number of sessions, and individual factors. We provide transparent pricing during consultation with no hidden charges."
          },
          {
                "question": "How many sessions of tear trough filler are needed?",
                "answer": "The number of sessions depends on your specific condition, its severity, and your treatment goals. We provide a clear treatment plan with expected timeline during consultation."
          },
          {
                "question": "Why should I choose Prime One for tear trough filler?",
                "answer": "Our clinic offers board-certified specialists, US FDA-approved equipment, personalized treatment plans, and a proven track record of 10,000+ satisfied patients in Vadodara."
          }
    ],

    ctaText: "Get Expert Tear Trough Filler Today",
    ctaDescription: "Stop waiting and start seeing results. Book a consultation with our specialist for personalized tear trough filler that actually works.",
  };

  return (
    <KeywordPageTemplate
      business={business}
      keyword="tear-trough-filler-in-vadodara"
      content={content}
    />
  );
}
