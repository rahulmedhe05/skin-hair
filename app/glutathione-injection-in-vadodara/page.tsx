...
export const metadata: Metadata = {
  title: "Leading Glutathione Injection in Vadodara | Prime One Clinic",
  description: "Glutathione Injection - Advanced solutions by board-certified specialists. ✓ Safe & effective ✓ Personalized care ✓ 4.9★ rated. Book today!",
  keywords: "glutathione, injection vadodara, glutathione injection near me, best glutathione injection vadodara",
  alternates: {
    canonical: "https://skinhairvadodara.in/glutathione-injection-in-vadodara",
  },
  openGraph: {
    title: "Leading Glutathione Injection in Vadodara | Prime One Hair & Skin Clinic",
    description: "Glutathione Injection - Advanced solutions by board-certified specialists. ✓ Safe & effective ✓ Personalized care ✓ 4.9★ rated. Book today!",
    url: "https://skinhairvadodara.in/glutathione-injection-in-vadodara",
...
export default function GlutathioneInjectionPage() {
  const content = {
    heroTitle: "Leading Glutathione Injection in Vadodara",
    heroSubtitle: "Clinically Proven Results with Glutathione Injection",
    
    introContent: `Uneven skin tone and pigmentation issues are among the most common concerns we see at our Vadodara clinic. Glutathione Injection requires both expertise and patience — there are no instant fixes, but with the right approach, significant improvement is absolutely achievable.
...
Our pigmentation protocols at Prime One Hair & Skin Clinic combine multiple modalities for comprehensive results. This typically includes medical-grade topical treatments, chemical peels customized to your skin type, laser or light-based therapies, and strict sun protection guidance. We also address internal factors through nutritional recommendations and hormonal assessment when relevant.`,
    ...
    faqItems: [
          {
                "question": "Is glutathione injection safe for dark skin?",
          ...
          {
                "question": "How long does glutathione injection take?",
    ...
    ctaText: "Get Expert Glutathione Injection Today",
    ctaDescription: "Professional glutathione injection doesn't have to be complicated or expensive. Book your consultation and discover your options today.",
  };

  return (
    <KeywordPageTemplate
      business={business}
      keyword="glutathione-injection-in-vadodara"
      content={content}
    />
  );
}
