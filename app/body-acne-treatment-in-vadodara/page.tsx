...
export const metadata: Metadata = {
  title: "Trusted Body Acne Treatment in Vadodara | Prime One Clinic",
  description: "✅ Body Acne Treatment by MD dermatologists at Prime One Clinic ✓ Proven results ✓ 10,000+ patients ✓ US FDA approved. Book consultation today!",
  keywords: "body, acne, treatment vadodara, body acne treatment near me, best body acne vadodara",
  alternates: {
    canonical: "https://skinhairvadodara.in/body-acne-treatment-in-vadodara",
  },
  openGraph: {
    title: "Trusted Body Acne Treatment in Vadodara | Prime One Hair & Skin Clinic",
    description: "✅ Body Acne Treatment by MD dermatologists at Prime One Clinic ✓ Proven results ✓ 10,000+ patients ✓ US FDA approved. Book consultation today!",
    url: "https://skinhairvadodara.in/body-acne-treatment-in-vadodara",
...
export default function BodyAcneTreatmentPage() {
  const content = {
    heroTitle: "Trusted Body Acne Treatment in Vadodara",
    heroSubtitle: "Where Science Meets Beauty",
    
    introContent: `Dealing with acne goes beyond the surface — it affects confidence, social interactions, and emotional well-being. If you're looking for body acne treatment, you deserve a treatment approach based on medical science, not marketing promises.
...
Our treatment success rate exceeds 90% because we take a systematic approach. We combine prescription-strength topical treatments, oral medications when necessary, and clinical procedures like chemical peels, LED therapy, or laser treatments. We also address the psychological impact of acne and provide realistic timelines so you know exactly what to expect.`,
    ...
    faqItems: [
          {
                "question": "How long does body acne treatment take to work?",
          ...
          {
                "question": "Is body acne treatment safe for sensitive skin?",
    ...
    ctaText: "Ready to Start Your Body Acne Treatment Journey?",
    ctaDescription: "Join 10,000+ satisfied patients who chose Prime One for their body acne treatment. Your transformation starts with a simple phone call.",
  };

  return (
    <KeywordPageTemplate
      business={business}
      keyword="body-acne-treatment-in-vadodara"
      content={content}
    />
  );
}
