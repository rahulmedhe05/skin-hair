...
export const metadata: Metadata = {
  title: "Trusted Adult Acne Treatment in Vadodara | Prime One Clinic",
  description: "Get the best adult acne treatment at Prime One Vadodara. ✓ MD dermatologists ✓ US FDA devices ✓ 10000+ happy patients. Consultation ₹500.",
  keywords: "adult, acne, treatment vadodara, adult acne treatment near me, best adult acne vadodara",
  alternates: {
    canonical: "https://skinhairvadodara.in/adult-acne-treatment-in-vadodara",
  },
  openGraph: {
    title: "Trusted Adult Acne Treatment in Vadodara | Prime One Hair & Skin Clinic",
    description: "Get the best adult acne treatment at Prime One Vadodara. ✓ MD dermatologists ✓ US FDA devices ✓ 10000+ happy patients. Consultation ₹500.",
    url: "https://skinhairvadodara.in/adult-acne-treatment-in-vadodara",
...
export default function AdultAcneTreatmentPage() {
  const content = {
    heroTitle: "Trusted Adult Acne Treatment in Vadodara",
    heroSubtitle: "Where Science Meets Beauty",
    
    introContent: `Dealing with acne goes beyond the surface — it affects confidence, social interactions, and emotional well-being. If you're looking for adult acne treatment, you deserve a treatment approach based on medical science, not marketing promises.
...
Our treatment success rate exceeds 90% because we take a systematic approach. We combine prescription-strength topical treatments, oral medications when necessary, and clinical procedures like chemical peels, LED therapy, or laser treatments. We also address the psychological impact of acne and provide realistic timelines so you know exactly what to expect.`,
    ...
    faqItems: [
          ...
          {
                "question": "Is adult acne treatment safe for sensitive skin?",
          ...
          {
                "question": "How long does adult acne treatment take to work?",
    ...
    ctaText: "Don't Wait — Book Your Adult Acne Treatment Now",
    ctaDescription: "Join 10,000+ satisfied patients who chose Prime One for their adult acne treatment. Your transformation starts with a simple phone call.",
  };

  return (
    <KeywordPageTemplate
      business={business}
      keyword="adult-acne-treatment-in-vadodara"
      content={content}
    />
  );
}
