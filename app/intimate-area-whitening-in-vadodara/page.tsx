...
export const metadata: Metadata = {
  title: "Advanced Intimate Area Whitening in Vadodara | Prime One Clinic",
  description: "✅ Intimate Area Whitening by MD dermatologists at Prime One Clinic ✓ Proven results ✓ 10,000+ patients ✓ US FDA approved. Book consultation today!",
  keywords: "intimate, area, whitening vadodara, intimate area whitening near me, best intimate area vadodara",
  alternates: {
    canonical: "https://skinhairvadodara.in/intimate-area-whitening-in-vadodara",
  },
  openGraph: {
    title: "Advanced Intimate Area Whitening in Vadodara | Prime One Hair & Skin Clinic",
    description: "✅ Intimate Area Whitening by MD dermatologists at Prime One Clinic ✓ Proven results ✓ 10,000+ patients ✓ US FDA approved. Book consultation today!",
    url: "https://skinhairvadodara.in/intimate-area-whitening-in-vadodara",
...
export default function IntimateAreaWhiteningPage() {
  const content = {
    heroTitle: "Advanced Intimate Area Whitening in Vadodara",
    heroSubtitle: "Board-Certified Specialists for Intimate Area Whitening",
    
    introContent: `Uneven skin tone and pigmentation issues are among the most common concerns we see at our Vadodara clinic. Intimate Area Whitening requires both expertise and patience — there are no instant fixes, but with the right approach, significant improvement is absolutely achievable.
...
Our pigmentation protocols at Prime One Hair & Skin Clinic combine multiple modalities for comprehensive results. This typically includes medical-grade topical treatments, chemical peels customized to your skin type, laser or light-based therapies, and strict sun protection guidance. We also address internal factors through nutritional recommendations and hormonal assessment when relevant.`,
    ...
    faqItems: [
          {
                "question": "How long does intimate area whitening take?",
          ...
          {
                "question": "Is intimate area whitening safe for dark skin?",
    ...
    ctaText: "Ready to Start Your Intimate Area Whitening Journey?",
    ctaDescription: "Join 10,000+ satisfied patients who chose Prime One for their intimate area whitening. Your transformation starts with a simple phone call.",
  };

  return (
    <KeywordPageTemplate
      business={business}
      keyword="intimate-area-whitening-in-vadodara"
      content={content}
    />
  );
}
