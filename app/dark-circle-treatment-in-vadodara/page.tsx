...
export const metadata: Metadata = {
  title: "Dark Circle Treatment Experts in Vadodara | Prime One Clinic",
  description: "🏆 Best dark circle treatment at Prime One Hair & Skin Clinic Vadodara ✓ Expert doctors ✓ Latest technology ✓ Affordable prices. Call now!",
  keywords: "dark, circle, treatment vadodara, dark circle treatment near me, best dark circle vadodara",
  alternates: {
    canonical: "https://skinhairvadodara.in/dark-circle-treatment-in-vadodara",
  },
  openGraph: {
    title: "Dark Circle Treatment Experts in Vadodara | Prime One Hair & Skin Clinic",
    description: "🏆 Best dark circle treatment at Prime One Hair & Skin Clinic Vadodara ✓ Expert doctors ✓ Latest technology ✓ Affordable prices. Call now!",
    url: "https://skinhairvadodara.in/dark-circle-treatment-in-vadodara",
...
export default function DarkCircleTreatmentPage() {
  const content = {
    heroTitle: "Dark Circle Treatment Experts in Vadodara",
    heroSubtitle: "Transform Your Appearance with Dark Circle Treatment",
    
    introContent: `Uneven skin tone and pigmentation issues are among the most common concerns we see at our Vadodara clinic. Dark Circle Treatment requires both expertise and patience — there are no instant fixes, but with the right approach, significant improvement is absolutely achievable.
...
Our pigmentation protocols at Prime One Hair & Skin Clinic combine multiple modalities for comprehensive results. This typically includes medical-grade topical treatments, chemical peels customized to your skin type, laser or light-based therapies, and strict sun protection guidance. We also address internal factors through nutritional recommendations and hormonal assessment when relevant.`,
    ...
    faqItems: [
          ...
          {
                "question": "How long does dark circle treatment take?",
          ...
          {
                "question": "Is dark circle treatment safe for dark skin?",
    ...
    ctaText: "Take the First Step Toward Dark Circle Treatment",
  ...
  return (
    <KeywordPageTemplate
      business={business}
      keyword="dark-circle-treatment-in-vadodara"
      content={content}
    />
  );
}
