...
export const metadata: Metadata = {
  title: "Advanced Uneven Skin Tone Treatment in Vadodara | Prime One Clinic",
  description: "✅ Uneven Skin Tone Treatment by MD dermatologists at Prime One Clinic ✓ Proven results ✓ 10,000+ patients ✓ US FDA approved. Book consultation today!",
  keywords: "uneven, skin, tone, treatment vadodara, uneven skin tone near me, best uneven skin vadodara",
  alternates: {
    canonical: "https://skinhairvadodara.in/uneven-skin-tone-treatment-in-vadodara",
  },
  openGraph: {
    title: "Advanced Uneven Skin Tone Treatment in Vadodara | Prime One Hair & Skin Clinic",
    description: "✅ Uneven Skin Tone Treatment by MD dermatologists at Prime One Clinic ✓ Proven results ✓ 10,000+ patients ✓ US FDA approved. Book consultation today!",
    url: "https://skinhairvadodara.in/uneven-skin-tone-treatment-in-vadodara",
...
export default function UnevenSkinToneTreatmentPage() {
  const content = {
    heroTitle: "Advanced Uneven Skin Tone Treatment in Vadodara",
    heroSubtitle: "Board-Certified Specialists for Uneven Skin Tone Treatment",
    
    introContent: `Uneven skin tone and pigmentation issues are among the most common concerns we see at our Vadodara clinic. Uneven Skin Tone Treatment requires both expertise and patience — there are no instant fixes, but with the right approach, significant improvement is absolutely achievable.
...
Our pigmentation protocols at Prime One Hair & Skin Clinic combine multiple modalities for comprehensive results. This typically includes medical-grade topical treatments, chemical peels customized to your skin type, laser or light-based therapies, and strict sun protection guidance. We also address internal factors through nutritional recommendations and hormonal assessment when relevant.`,
    ...
    faqItems: [
          {
                "question": "How long does uneven skin tone treatment take?",
          ...
          {
                "question": "Is uneven skin tone treatment safe for dark skin?",
    ...
    ctaText: "Ready to Start Your Uneven Skin Tone Treatment Journey?",
    ctaDescription: "Join 10,000+ satisfied patients who chose Prime One for their uneven skin tone treatment. Your transformation starts with a simple phone call.",
  };

  return (
    <KeywordPageTemplate
      business={business}
      keyword="uneven-skin-tone-treatment-in-vadodara"
      content={content}
    />
  );
}
