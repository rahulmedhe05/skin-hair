...
export const metadata: Metadata = {
  title: "Premium Under Eye Dark Circle Treatment in Vadodara | Prime One Clinic",
  description: "🏆 Best under eye dark circle treatment at Prime One Hair & Skin Clinic Vadodara ✓ Expert doctors ✓ Latest technology ✓ Affordable prices. Call now!",
  keywords: "under, eye, dark, circle, treatment vadodara, under eye dark near me, best under eye vadodara",
  alternates: {
    canonical: "https://skinhairvadodara.in/under-eye-dark-circle-treatment-in-vadodara",
  },
  openGraph: {
    title: "Premium Under Eye Dark Circle Treatment in Vadodara | Prime One Hair & Skin Clinic",
    description: "🏆 Best under eye dark circle treatment at Prime One Hair & Skin Clinic Vadodara ✓ Expert doctors ✓ Latest technology ✓ Affordable prices. Call now!",
    url: "https://skinhairvadodara.in/under-eye-dark-circle-treatment-in-vadodara",
...
export default function UnderEyeDarkCircleTreatmentPage() {
  const content = {
    heroTitle: "Premium Under Eye Dark Circle Treatment in Vadodara",
    heroSubtitle: "Safe, Effective & Affordable Under Eye Dark Circle Treatment",
    
    introContent: `Uneven skin tone and pigmentation issues are among the most common concerns we see at our Vadodara clinic. Under Eye Dark Circle Treatment requires both expertise and patience — there are no instant fixes, but with the right approach, significant improvement is absolutely achievable.
...
Our pigmentation protocols at Prime One Hair & Skin Clinic combine multiple modalities for comprehensive results. This typically includes medical-grade topical treatments, chemical peels customized to your skin type, laser or light-based therapies, and strict sun protection guidance. We also address internal factors through nutritional recommendations and hormonal assessment when relevant.`,
    ...
    faqItems: [
          ...
          {
                "question": "How long does under eye dark circle treatment take?",
          ...
          {
                "question": "Is under eye dark circle treatment safe for dark skin?",
    ...
    ctaText: "Take the First Step Toward Under Eye Dark Circle Treatment",
    ctaDescription: "Stop waiting and start seeing results. Book a consultation with our specialist for personalized under eye dark circle treatment that actually works.",
  };

  return (
    <KeywordPageTemplate
      business={business}
      keyword="under-eye-dark-circle-treatment-in-vadodara"
      content={content}
    />
  );
}
