...
export const metadata: Metadata = {
  title: "Professional Anti Aging Facial in Vadodara | Prime One Clinic",
  description: "Anti Aging Facial - Advanced solutions by board-certified specialists. ✓ Safe & effective ✓ Personalized care ✓ 4.9★ rated. Book today!",
  keywords: "anti, aging, facial vadodara, anti aging facial near me, best anti aging vadodara",
  alternates: {
    canonical: "https://skinhairvadodara.in/anti-aging-facial-in-vadodara",
  },
  openGraph: {
    title: "Professional Anti Aging Facial in Vadodara | Prime One Hair & Skin Clinic",
    description: "Anti Aging Facial - Advanced solutions by board-certified specialists. ✓ Safe & effective ✓ Personalized care ✓ 4.9★ rated. Book today!",
    url: "https://skinhairvadodara.in/anti-aging-facial-in-vadodara",
...
export default function AntiAgingFacialPage() {
  const content = {
    heroTitle: "Professional Anti Aging Facial in Vadodara",
    heroSubtitle: "Personalized Anti Aging Facial for Lasting Results",
    
    introContent: `Aging is natural, but how you age is largely within your control. Anti Aging Facial at Prime One Hair & Skin Clinic focuses on natural-looking rejuvenation that enhances your features rather than changing them.
...
We believe in a conservative, buildable approach. Starting subtle and adding more as needed always produces better results than doing too much at once. Our patients consistently tell us that friends notice they look refreshed and rested — but can't pinpoint exactly what changed. That's the mark of truly skilled aesthetic work.`,
    ...
    faqItems: [
          {
                "question": "Is anti aging facial safe?",
                "answer": "When performed by qualified dermatologists using approved equipment and products, anti aging facial is safe and effective. We follow strict safety protocols and discuss all potential risks beforehand."
          },
          {
                "question": "What is anti aging facial?",
                "answer": "Anti Aging Facial involves specialized medical procedures performed by qualified dermatologists to address your specific concerns. We use evidence-based approaches tailored to each patient's needs."
          },
          {
                "question": "How much does anti aging facial cost in Vadodara?",
                "answer": "Anti Aging Facial costs vary based on the specific treatment required, number of sessions, and individual factors. We provide transparent pricing during consultation with no hidden charges."
          },
          {
                "question": "How many sessions of anti aging facial are needed?",
                "answer": "The number of sessions depends on your specific condition, its severity, and your treatment goals. We provide a clear treatment plan with expected timeline during consultation."
          },
          {
                "question": "Why should I choose Prime One for anti aging facial?",
                "answer": "Our clinic offers board-certified specialists, US FDA-approved equipment, personalized treatment plans, and a proven track record of 10,000+ satisfied patients in Vadodara."
          }
    ],

    ctaText: "Get Expert Anti Aging Facial Today",
  ...
  return (
    <KeywordPageTemplate
      business={business}
      keyword="anti-aging-facial-in-vadodara"
      content={content}
    />
  );
}
