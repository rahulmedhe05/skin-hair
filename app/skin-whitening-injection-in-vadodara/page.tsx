...
export const metadata: Metadata = {
  title: "Trusted Skin Whitening Injection in Vadodara | Prime One Clinic",
  description: "🏆 Best skin whitening injection at Prime One Hair & Skin Clinic Vadodara ✓ Expert doctors ✓ Latest technology ✓ Affordable prices. Call now!",
  keywords: "skin, whitening, injection vadodara, skin whitening injection near me, best skin whitening vadodara",
  alternates: {
    canonical: "https://skinhairvadodara.in/skin-whitening-injection-in-vadodara",
  },
  openGraph: {
    title: "Trusted Skin Whitening Injection in Vadodara | Prime One Hair & Skin Clinic",
    description: "🏆 Best skin whitening injection at Prime One Hair & Skin Clinic Vadodara ✓ Expert doctors ✓ Latest technology ✓ Affordable prices. Call now!",
    url: "https://skinhairvadodara.in/skin-whitening-injection-in-vadodara",
...
export default function SkinWhiteningInjectionPage() {
  const content = {
    heroTitle: "Trusted Skin Whitening Injection in Vadodara",
    heroSubtitle: "Where Science Meets Beauty",
    
    introContent: `Uneven skin tone and pigmentation issues are among the most common concerns we see at our Vadodara clinic. Skin Whitening Injection requires both expertise and patience — there are no instant fixes, but with the right approach, significant improvement is absolutely achievable.
...
Our pigmentation protocols at Prime One Hair & Skin Clinic combine multiple modalities for comprehensive results. This typically includes medical-grade topical treatments, chemical peels customized to your skin type, laser or light-based therapies, and strict sun protection guidance. We also address internal factors through nutritional recommendations and hormonal assessment when relevant.`,
    ...
    faqItems: [
          ...
          {
                "question": "How long does skin whitening injection take?",
          ...
          {
                "question": "Is skin whitening injection safe for dark skin?",
    ...
    ctaText: "Take the First Step Toward Skin Whitening Injection",
    ctaDescription: "Join 10,000+ satisfied patients who chose Prime One for their skin whitening injection. Your transformation starts with a simple phone call.",
  };

  return (
    <KeywordPageTemplate
      business={business}
      keyword="skin-whitening-injection-in-vadodara"
      content={content}
    />
  );
}
