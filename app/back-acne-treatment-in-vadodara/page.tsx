...
export const metadata: Metadata = {
  title: "Expert Back Acne Treatment Solutions in Vadodara | Prime One Clinic",
  description: "🏆 Best back acne treatment at Prime One Hair & Skin Clinic Vadodara ✓ Expert doctors ✓ Latest technology ✓ Affordable prices. Call now!",
  keywords: "back, acne, treatment vadodara, back acne treatment near me, best back acne vadodara",
  alternates: {
    canonical: "https://skinhairvadodara.in/back-acne-treatment-in-vadodara",
  },
  openGraph: {
    title: "Expert Back Acne Treatment Solutions in Vadodara | Prime One Hair & Skin Clinic",
    description: "🏆 Best back acne treatment at Prime One Hair & Skin Clinic Vadodara ✓ Expert doctors ✓ Latest technology ✓ Affordable prices. Call now!",
    url: "https://skinhairvadodara.in/back-acne-treatment-in-vadodara",
...
export default function BackAcneTreatmentPage() {
  const content = {
    heroTitle: "Expert Back Acne Treatment Solutions in Vadodara",
    heroSubtitle: "Your Journey to Better Skin & Hair Starts Here",
    
    introContent: `Dealing with acne goes beyond the surface — it affects confidence, social interactions, and emotional well-being. If you're looking for back acne treatment, you deserve a treatment approach based on medical science, not marketing promises.
...
Our treatment success rate exceeds 90% because we take a systematic approach. We combine prescription-strength topical treatments, oral medications when necessary, and clinical procedures like chemical peels, LED therapy, or laser treatments. We also address the psychological impact of acne and provide realistic timelines so you know exactly what to expect.`,
    ...
    faqItems: [
          ...
          {
                "question": "How long does back acne treatment take to work?",
          ...
          {
                "question": "Is back acne treatment safe for sensitive skin?",
    ...
    ctaText: "Take the First Step Toward Back Acne Treatment",
    ctaDescription: "Professional back acne treatment doesn't have to be complicated or expensive. Book your consultation and discover your options today.",
  };

  return (
    <KeywordPageTemplate
      business={business}
      keyword="back-acne-treatment-in-vadodara"
      content={content}
    />
  );
}
