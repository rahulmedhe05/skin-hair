...
export const metadata: Metadata = {
  title: "Trusted Age Spot Removal in Vadodara | Prime One Clinic",
  description: "🏆 Best age spot removal at Prime One Hair & Skin Clinic Vadodara ✓ Expert doctors ✓ Latest technology ✓ Affordable prices. Call now!",
  keywords: "age, spot, removal vadodara, age spot removal near me, best age spot vadodara",
  alternates: {
    canonical: "https://skinhairvadodara.in/age-spot-removal-in-vadodara",
  },
  openGraph: {
    title: "Trusted Age Spot Removal in Vadodara | Prime One Hair & Skin Clinic",
    description: "🏆 Best age spot removal at Prime One Hair & Skin Clinic Vadodara ✓ Expert doctors ✓ Latest technology ✓ Affordable prices. Call now!",
    url: "https://skinhairvadodara.in/age-spot-removal-in-vadodara",
...
export default function AgeSpotRemovalPage() {
  const content = {
    heroTitle: "Trusted Age Spot Removal in Vadodara",
    heroSubtitle: "Where Science Meets Beauty",
    
    introContent: `Uneven skin tone and pigmentation issues are among the most common concerns we see at our Vadodara clinic. Age Spot Removal requires both expertise and patience — there are no instant fixes, but with the right approach, significant improvement is absolutely achievable.
...
Our pigmentation protocols at Prime One Hair & Skin Clinic combine multiple modalities for comprehensive results. This typically includes medical-grade topical treatments, chemical peels customized to your skin type, laser or light-based therapies, and strict sun protection guidance. We also address internal factors through nutritional recommendations and hormonal assessment when relevant.`,
    ...
    faqItems: [
          ...
          {
                "question": "How long does age spot removal take?",
          ...
          {
                "question": "Is age spot removal safe for dark skin?",
    ...
    ctaText: "Take the First Step Toward Age Spot Removal",
    ctaDescription: "Join 10,000+ satisfied patients who chose Prime One for their age spot removal. Your transformation starts with a simple phone call.",
  };

  return (
    <KeywordPageTemplate
      business={business}
      keyword="age-spot-removal-in-vadodara"
      content={content}
    />
  );
}
