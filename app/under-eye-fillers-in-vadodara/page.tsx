...
export const metadata: Metadata = {
  title: "Under Eye Fillers Experts in Vadodara | Prime One Clinic",
  description: "Under Eye Fillers - Advanced solutions by board-certified specialists. ✓ Safe & effective ✓ Personalized care ✓ 4.9★ rated. Book today!",
  keywords: "under, eye, fillers vadodara, under eye fillers near me, best under eye vadodara",
  alternates: {
    canonical: "https://skinhairvadodara.in/under-eye-fillers-in-vadodara",
  },
  openGraph: {
    title: "Under Eye Fillers Experts in Vadodara | Prime One Hair & Skin Clinic",
    description: "Under Eye Fillers - Advanced solutions by board-certified specialists. ✓ Safe & effective ✓ Personalized care ✓ 4.9★ rated. Book today!",
    url: "https://skinhairvadodara.in/under-eye-fillers-in-vadodara",
...
export default function UnderEyeFillersPage() {
  const content = {
    heroTitle: "Under Eye Fillers Experts in Vadodara",
    heroSubtitle: "Transform Your Appearance with Under Eye Fillers",
    
    introContent: `Aging is natural, but how you age is largely within your control. Under Eye Fillers at Prime One Hair & Skin Clinic focuses on natural-looking rejuvenation that enhances your features rather than changing them.
...
We believe in a conservative, buildable approach. Starting subtle and adding more as needed always produces better results than doing too much at once. Our patients consistently tell us that friends notice they look refreshed and rested — but can't pinpoint exactly what changed. That's the mark of truly skilled aesthetic work.`,
    ...
    faqItems: [
          {
                ...
                "answer": "When performed by qualified dermatologists using approved equipment and products, under eye fillers is safe and effective. We follow strict safety protocols and discuss all potential risks beforehand."
          },
          {
                "question": "What is under eye fillers?",
                "answer": "Under Eye Fillers involves specialized medical procedures performed by qualified dermatologists to address your specific concerns. We use evidence-based approaches tailored to each patient's needs."
          },
          {
                "question": "How much does under eye fillers cost in Vadodara?",
                "answer": "Under Eye Fillers costs vary based on the specific treatment required, number of sessions, and individual factors. We provide transparent pricing during consultation with no hidden charges."
          },
          {
                "question": "How many sessions of under eye fillers are needed?",
                "answer": "The number of sessions depends on your specific condition, its severity, and your treatment goals. We provide a clear treatment plan with expected timeline during consultation."
          },
          {
                "question": "Why should I choose Prime One for under eye fillers?",
                "answer": "Our clinic offers board-certified specialists, US FDA-approved equipment, personalized treatment plans, and a proven track record of 10,000+ satisfied patients in Vadodara."
          }
    ],

    ctaText: "Get Expert Under Eye Fillers Today",
  ...
  return (
    <KeywordPageTemplate
      business={business}
      keyword="under-eye-fillers-in-vadodara"
      content={content}
    />
  );
}
