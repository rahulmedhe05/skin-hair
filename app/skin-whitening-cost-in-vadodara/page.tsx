...
export const metadata: Metadata = {
  title: "Premium Skin Whitening Cost in Vadodara | Prime One Clinic",
  description: "Get the best skin whitening cost at Prime One Vadodara. ✓ MD dermatologists ✓ US FDA devices ✓ 10000+ happy patients. Consultation ₹500.",
  keywords: "skin, whitening, cost vadodara, skin whitening cost near me, best skin whitening vadodara",
  alternates: {
    canonical: "https://skinhairvadodara.in/skin-whitening-cost-in-vadodara",
  },
  openGraph: {
    title: "Premium Skin Whitening Cost in Vadodara | Prime One Hair & Skin Clinic",
    description: "Get the best skin whitening cost at Prime One Vadodara. ✓ MD dermatologists ✓ US FDA devices ✓ 10000+ happy patients. Consultation ₹500.",
    url: "https://skinhairvadodara.in/skin-whitening-cost-in-vadodara",
...
export default function SkinWhiteningCostPage() {
  const content = {
    heroTitle: "Premium Skin Whitening Cost in Vadodara",
    heroSubtitle: "Safe, Effective & Affordable Skin Whitening Cost",
    
    introContent: `Uneven skin tone and pigmentation issues are among the most common concerns we see at our Vadodara clinic. Skin Whitening Cost requires both expertise and patience — there are no instant fixes, but with the right approach, significant improvement is absolutely achievable.
...
Our pigmentation protocols at Prime One Hair & Skin Clinic combine multiple modalities for comprehensive results. This typically includes medical-grade topical treatments, chemical peels customized to your skin type, laser or light-based therapies, and strict sun protection guidance. We also address internal factors through nutritional recommendations and hormonal assessment when relevant.`,
    ...
    faqItems: [
          ...
          {
                "question": "Is skin whitening cost safe for dark skin?",
          ...
          {
                "question": "How long does skin whitening cost take?",
    ...
    ctaText: "Don't Wait — Book Your Skin Whitening Cost Now",
    ctaDescription: "Stop waiting and start seeing results. Book a consultation with our specialist for personalized skin whitening cost that actually works.",
  };

  return (
    <KeywordPageTemplate
      business={business}
      keyword="skin-whitening-cost-in-vadodara"
      content={content}
    />
  );
}
