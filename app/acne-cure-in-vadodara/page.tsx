...
export const metadata: Metadata = {
  title: "Best Acne Cure in Vadodara | Prime One Clinic",
  description: "Get the best acne cure at Prime One Vadodara. ✓ MD dermatologists ✓ US FDA devices ✓ 10000+ happy patients. Consultation ₹500.",
  keywords: "acne, cure vadodara, acne cure near me, best acne cure vadodara",
  alternates: {
    canonical: "https://skinhairvadodara.in/acne-cure-in-vadodara",
  },
  openGraph: {
    title: "Best Acne Cure in Vadodara | Prime One Hair & Skin Clinic",
    description: "Get the best acne cure at Prime One Vadodara. ✓ MD dermatologists ✓ US FDA devices ✓ 10000+ happy patients. Consultation ₹500.",
    url: "https://skinhairvadodara.in/acne-cure-in-vadodara",
...
export default function AcneCurePage() {
  const content = {
    heroTitle: "Best Acne Cure in Vadodara",
    heroSubtitle: "Evidence-Based Acne Cure That Actually Works",
    
    introContent: `Dealing with acne goes beyond the surface — it affects confidence, social interactions, and emotional well-being. If you're looking for acne cure, you deserve a treatment approach based on medical science, not marketing promises.
...
Our treatment success rate exceeds 90% because we take a systematic approach. We combine prescription-strength topical treatments, oral medications when necessary, and clinical procedures like chemical peels, LED therapy, or laser treatments. We also address the psychological impact of acne and provide realistic timelines so you know exactly what to expect.`,
    ...
    faqItems: [
          ...
          {
                "question": "Is acne cure safe for sensitive skin?",
          ...
          {
                "question": "How long does acne cure take to work?",
    ...
    ctaText: "Don't Wait — Book Your Acne Cure Now",
    ctaDescription: "Stop waiting and start seeing results. Book a consultation with our specialist for personalized acne cure that actually works.",
  };

  return (
    <KeywordPageTemplate
      business={business}
      keyword="acne-cure-in-vadodara"
      content={content}
    />
  );
}
