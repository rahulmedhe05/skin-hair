...
export const metadata: Metadata = {
  title: "Expert Underarm Whitening Solutions in Vadodara | Prime One Clinic",
  description: "Looking for underarm whitening? Prime One Clinic offers expert care with proven results. ✓ 15+ years experience ✓ Modern technology. Call now!",
  keywords: "underarm, whitening vadodara, underarm whitening near me, best underarm whitening vadodara",
  alternates: {
    canonical: "https://skinhairvadodara.in/underarm-whitening-in-vadodara",
  },
  openGraph: {
    title: "Expert Underarm Whitening Solutions in Vadodara | Prime One Hair & Skin Clinic",
    description: "Looking for underarm whitening? Prime One Clinic offers expert care with proven results. ✓ 15+ years experience ✓ Modern technology. Call now!",
    url: "https://skinhairvadodara.in/underarm-whitening-in-vadodara",
...
export default function UnderarmWhiteningPage() {
  const content = {
    heroTitle: "Expert Underarm Whitening Solutions in Vadodara",
    heroSubtitle: "Your Journey to Better Skin & Hair Starts Here",
    
    introContent: `Uneven skin tone and pigmentation issues are among the most common concerns we see at our Vadodara clinic. Underarm Whitening requires both expertise and patience — there are no instant fixes, but with the right approach, significant improvement is absolutely achievable.
...
Our pigmentation protocols at Prime One Hair & Skin Clinic combine multiple modalities for comprehensive results. This typically includes medical-grade topical treatments, chemical peels customized to your skin type, laser or light-based therapies, and strict sun protection guidance. We also address internal factors through nutritional recommendations and hormonal assessment when relevant.`,
    ...
    faqItems: [
          ...
          {
                "question": "Is underarm whitening safe for dark skin?",
          ...
          {
                "question": "How long does underarm whitening take?",
    ...
    ctaText: "Your Underarm Whitening Consultation Awaits",
    ctaDescription: "Professional underarm whitening doesn't have to be complicated or expensive. Book your consultation and discover your options today.",
  };

  return (
    <KeywordPageTemplate
      business={business}
      keyword="underarm-whitening-in-vadodara"
      content={content}
    />
  );
}
