...
export const metadata: Metadata = {
  title: "Advanced Face Lift in Vadodara | Prime One Clinic",
  description: "Get the best face lift at Prime One Vadodara. ✓ MD dermatologists ✓ US FDA devices ✓ 10000+ happy patients. Consultation ₹500.",
  keywords: "face, lift vadodara, face lift near me, best face lift vadodara",
  alternates: {
    canonical: "https://skinhairvadodara.in/face-lift-in-vadodara",
  },
  openGraph: {
    title: "Advanced Face Lift in Vadodara | Prime One Hair & Skin Clinic",
    description: "Get the best face lift at Prime One Vadodara. ✓ MD dermatologists ✓ US FDA devices ✓ 10000+ happy patients. Consultation ₹500.",
    url: "https://skinhairvadodara.in/face-lift-in-vadodara",
...
export default function FaceLiftPage() {
  const content = {
    heroTitle: "Advanced Face Lift in Vadodara",
    heroSubtitle: "Board-Certified Specialists for Face Lift",
    
    introContent: `Aging is natural, but how you age is largely within your control. Face Lift at Prime One Hair & Skin Clinic focuses on natural-looking rejuvenation that enhances your features rather than changing them.
...
We believe in a conservative, buildable approach. Starting subtle and adding more as needed always produces better results than doing too much at once. Our patients consistently tell us that friends notice they look refreshed and rested — but can't pinpoint exactly what changed. That's the mark of truly skilled aesthetic work.`,
    ...
    faqItems: [
          {
                "question": "Why should I choose Prime One for face lift?",
                "answer": "Our clinic offers board-certified specialists, US FDA-approved equipment, personalized treatment plans, and a proven track record of 10,000+ satisfied patients in Vadodara."
          },
          {
                "question": "Is face lift safe?",
                "answer": "When performed by qualified dermatologists using approved equipment and products, face lift is safe and effective. We follow strict safety protocols and discuss all potential risks beforehand."
          },
          {
                "question": "How many sessions of face lift are needed?",
                "answer": "The number of sessions depends on your specific condition, its severity, and your treatment goals. We provide a clear treatment plan with expected timeline during consultation."
          },
          {
                "question": "What is face lift?",
                "answer": "Face Lift involves specialized medical procedures performed by qualified dermatologists to address your specific concerns. We use evidence-based approaches tailored to each patient's needs."
          },
          {
                "question": "How much does face lift cost in Vadodara?",
                "answer": "Face Lift costs vary based on the specific treatment required, number of sessions, and individual factors. We provide transparent pricing during consultation with no hidden charges."
          }
    ],

    ctaText: "Don't Wait — Book Your Face Lift Now",
    ctaDescription: "Join 10,000+ satisfied patients who chose Prime One for their face lift. Your transformation starts with a simple phone call.",
  };

  return (
    <KeywordPageTemplate
      business={business}
      keyword="face-lift-in-vadodara"
      content={content}
    />
  );
}
