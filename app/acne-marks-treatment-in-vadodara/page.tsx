...
export const metadata: Metadata = {
  title: "Premium Acne Marks Treatment in Vadodara | Prime One Clinic",
  description: "✅ Acne Marks Treatment by MD dermatologists at Prime One Clinic ✓ Proven results ✓ 10,000+ patients ✓ US FDA approved. Book consultation today!",
  keywords: "acne, marks, treatment vadodara, acne marks treatment near me, best acne marks vadodara",
  alternates: {
    canonical: "https://skinhairvadodara.in/acne-marks-treatment-in-vadodara",
  },
  openGraph: {
    title: "Premium Acne Marks Treatment in Vadodara | Prime One Hair & Skin Clinic",
    description: "✅ Acne Marks Treatment by MD dermatologists at Prime One Clinic ✓ Proven results ✓ 10,000+ patients ✓ US FDA approved. Book consultation today!",
    url: "https://skinhairvadodara.in/acne-marks-treatment-in-vadodara",
...
export default function AcneMarksTreatmentPage() {
  const content = {
    heroTitle: "Premium Acne Marks Treatment in Vadodara",
    heroSubtitle: "Safe, Effective & Affordable Acne Marks Treatment",
    
    introContent: `Dealing with acne goes beyond the surface — it affects confidence, social interactions, and emotional well-being. If you're looking for acne marks treatment, you deserve a treatment approach based on medical science, not marketing promises.
...
Our treatment success rate exceeds 90% because we take a systematic approach. We combine prescription-strength topical treatments, oral medications when necessary, and clinical procedures like chemical peels, LED therapy, or laser treatments. We also address the psychological impact of acne and provide realistic timelines so you know exactly what to expect.`,
    ...
    faqItems: [
          {
                "question": "How long does acne marks treatment take to work?",
          ...
          {
                "question": "Is acne marks treatment safe for sensitive skin?",
    ...
    ctaText: "Ready to Start Your Acne Marks Treatment Journey?",
    ctaDescription: "Stop waiting and start seeing results. Book a consultation with our specialist for personalized acne marks treatment that actually works.",
  };

  return (
    <KeywordPageTemplate
      business={business}
      keyword="acne-marks-treatment-in-vadodara"
      content={content}
    />
  );
}
