...
export const metadata: Metadata = {
  title: "Advanced Skin Discoloration Treatment in Vadodara | Prime One Clinic",
  description: "Skin Discoloration Treatment - Advanced solutions by board-certified specialists. ✓ Safe & effective ✓ Personalized care ✓ 4.9★ rated. Book today!",
  keywords: "skin, discoloration, treatment vadodara, skin discoloration treatment near me, best skin discoloration vadodara",
  alternates: {
    canonical: "https://skinhairvadodara.in/skin-discoloration-treatment-in-vadodara",
  },
  openGraph: {
    title: "Advanced Skin Discoloration Treatment in Vadodara | Prime One Hair & Skin Clinic",
    description: "Skin Discoloration Treatment - Advanced solutions by board-certified specialists. ✓ Safe & effective ✓ Personalized care ✓ 4.9★ rated. Book today!",
    url: "https://skinhairvadodara.in/skin-discoloration-treatment-in-vadodara",
...
export default function SkinDiscolorationTreatmentPage() {
  const content = {
    heroTitle: "Advanced Skin Discoloration Treatment in Vadodara",
    heroSubtitle: "Board-Certified Specialists for Skin Discoloration Treatment",
    
    introContent: `Uneven skin tone and pigmentation issues are among the most common concerns we see at our Vadodara clinic. Skin Discoloration Treatment requires both expertise and patience — there are no instant fixes, but with the right approach, significant improvement is absolutely achievable.
...
Our pigmentation protocols at Prime One Hair & Skin Clinic combine multiple modalities for comprehensive results. This typically includes medical-grade topical treatments, chemical peels customized to your skin type, laser or light-based therapies, and strict sun protection guidance. We also address internal factors through nutritional recommendations and hormonal assessment when relevant.`,
    ...
    faqItems: [
          {
                "question": "Is skin discoloration treatment safe for dark skin?",
          ...
          {
                "question": "How long does skin discoloration treatment take?",
    ...
    ctaText: "Get Expert Skin Discoloration Treatment Today",
    ctaDescription: "Join 10,000+ satisfied patients who chose Prime One for their skin discoloration treatment. Your transformation starts with a simple phone call.",
  };

  return (
    <KeywordPageTemplate
      business={business}
      keyword="skin-discoloration-treatment-in-vadodara"
      content={content}
    />
  );
}
