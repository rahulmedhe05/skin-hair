...
export const metadata: Metadata = {
  title: "Expert Whitehead Treatment Solutions in Vadodara | Prime One Clinic",
  description: "Whitehead Treatment - Advanced solutions by board-certified specialists. ✓ Safe & effective ✓ Personalized care ✓ 4.9★ rated. Book today!",
  keywords: "whitehead, treatment vadodara, whitehead treatment near me, best whitehead treatment vadodara",
  alternates: {
    canonical: "https://skinhairvadodara.in/whitehead-treatment-in-vadodara",
  },
  openGraph: {
    title: "Expert Whitehead Treatment Solutions in Vadodara | Prime One Hair & Skin Clinic",
    description: "Whitehead Treatment - Advanced solutions by board-certified specialists. ✓ Safe & effective ✓ Personalized care ✓ 4.9★ rated. Book today!",
    url: "https://skinhairvadodara.in/whitehead-treatment-in-vadodara",
...
export default function WhiteheadTreatmentPage() {
  const content = {
    heroTitle: "Expert Whitehead Treatment Solutions in Vadodara",
    heroSubtitle: "Your Journey to Better Skin & Hair Starts Here",
    
    introContent: `Dealing with acne goes beyond the surface — it affects confidence, social interactions, and emotional well-being. If you're looking for whitehead treatment, you deserve a treatment approach based on medical science, not marketing promises.
...
Our treatment success rate exceeds 90% because we take a systematic approach. We combine prescription-strength topical treatments, oral medications when necessary, and clinical procedures like chemical peels, LED therapy, or laser treatments. We also address the psychological impact of acne and provide realistic timelines so you know exactly what to expect.`,
    ...
    faqItems: [
          ...
          {
                "question": "How long does whitehead treatment take to work?",
          ...
          {
                "question": "Is whitehead treatment safe for sensitive skin?",
    ...
    ctaText: "Get Expert Whitehead Treatment Today",
    ctaDescription: "Professional whitehead treatment doesn't have to be complicated or expensive. Book your consultation and discover your options today.",
  };

  return (
    <KeywordPageTemplate
      business={business}
      keyword="whitehead-treatment-in-vadodara"
      content={content}
    />
  );
}
