...
export const metadata: Metadata = {
  title: "Trusted Postpartum Hair Loss Treatment in Vadodara | Prime One Clinic",
  description: "Looking for postpartum hair loss treatment? Prime One Clinic offers expert care with proven results. ✓ 15+ years experience ✓ Modern technology. Call now!",
  keywords: "postpartum, hair, loss, treatment vadodara, postpartum hair loss near me, best postpartum hair vadodara",
  alternates: {
    canonical: "https://skinhairvadodara.in/postpartum-hair-loss-treatment-in-vadodara",
  },
  openGraph: {
    title: "Trusted Postpartum Hair Loss Treatment in Vadodara | Prime One Hair & Skin Clinic",
    description: "Looking for postpartum hair loss treatment? Prime One Clinic offers expert care with proven results. ✓ 15+ years experience ✓ Modern technology. Call now!",
    url: "https://skinhairvadodara.in/postpartum-hair-loss-treatment-in-vadodara",
...
export default function PostpartumHairLossTreatmentPage() {
  const content = {
    heroTitle: "Trusted Postpartum Hair Loss Treatment in Vadodara",
    heroSubtitle: "Where Science Meets Beauty",
    
    introContent: `Hair thinning and loss affect millions of people, yet most suffer in silence or waste money on products that don't work. If you're searching for postpartum hair loss treatment, you need to understand that effective treatment starts with proper diagnosis.
...
Our treatment protocols combine multiple evidence-based approaches for the best results. Depending on your diagnosis, this might include medical therapy, PRP or GFC treatments, low-level laser therapy, nutritional supplementation, and lifestyle modifications. We track progress through regular follow-ups and digital photography so you can see measurable improvement.`,
    ...
    faqItems: [
          {
                "question": "How effective is postpartum hair loss treatment?",
    ...
    ctaText: "Your Postpartum Hair Loss Treatment Consultation Awaits",
    ctaDescription: "Join 10,000+ satisfied patients who chose Prime One for their postpartum hair loss treatment. Your transformation starts with a simple phone call.",
  };

  return (
    <KeywordPageTemplate
      business={business}
      keyword="postpartum-hair-loss-treatment-in-vadodara"
      content={content}
    />
  );
}
