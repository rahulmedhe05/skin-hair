...
export const metadata: Metadata = {
  title: "Premium Best Acne Treatment in Vadodara | Prime One Clinic",
  description: "Looking for best acne treatment? Prime One Clinic offers expert care with proven results. ✓ 15+ years experience ✓ Modern technology. Call now!",
  keywords: "best, acne, treatment vadodara, best acne treatment near me, best best acne vadodara",
  alternates: {
    canonical: "https://skinhairvadodara.in/best-acne-treatment-in-vadodara",
  },
  openGraph: {
    title: "Premium Best Acne Treatment in Vadodara | Prime One Hair & Skin Clinic",
    description: "Looking for best acne treatment? Prime One Clinic offers expert care with proven results. ✓ 15+ years experience ✓ Modern technology. Call now!",
    url: "https://skinhairvadodara.in/best-acne-treatment-in-vadodara",
...
export default function BestAcneTreatmentPage() {
  const content = {
    heroTitle: "Premium Best Acne Treatment in Vadodara",
    heroSubtitle: "Safe, Effective & Affordable Best Acne Treatment",
    
    introContent: `Dealing with acne goes beyond the surface — it affects confidence, social interactions, and emotional well-being. If you're looking for best acne treatment, you deserve a treatment approach based on medical science, not marketing promises.
...
Our treatment success rate exceeds 90% because we take a systematic approach. We combine prescription-strength topical treatments, oral medications when necessary, and clinical procedures like chemical peels, LED therapy, or laser treatments. We also address the psychological impact of acne and provide realistic timelines so you know exactly what to expect.`,
    ...
    faqItems: [
          {
                "question": "Is best acne treatment safe for sensitive skin?",
          ...
          {
                "question": "How long does best acne treatment take to work?",
    ...
    ctaText: "Your Best Acne Treatment Consultation Awaits",
    ctaDescription: "Stop waiting and start seeing results. Book a consultation with our specialist for personalized best acne treatment that actually works.",
  };

  return (
    <KeywordPageTemplate
      business={business}
      keyword="best-acne-treatment-in-vadodara"
      content={content}
    />
  );
}
