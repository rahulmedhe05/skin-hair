...
export const metadata: Metadata = {
  title: "Leading Hyperpigmentation Treatment in Vadodara | Prime One Clinic",
  description: "🏆 Best hyperpigmentation treatment at Prime One Hair & Skin Clinic Vadodara ✓ Expert doctors ✓ Latest technology ✓ Affordable prices. Call now!",
  keywords: "hyperpigmentation, treatment vadodara, hyperpigmentation treatment near me, best hyperpigmentation treatment vadodara",
  alternates: {
    canonical: "https://skinhairvadodara.in/hyperpigmentation-treatment-in-vadodara",
  },
  openGraph: {
    title: "Leading Hyperpigmentation Treatment in Vadodara | Prime One Hair & Skin Clinic",
    description: "🏆 Best hyperpigmentation treatment at Prime One Hair & Skin Clinic Vadodara ✓ Expert doctors ✓ Latest technology ✓ Affordable prices. Call now!",
    url: "https://skinhairvadodara.in/hyperpigmentation-treatment-in-vadodara",
...
export default function HyperpigmentationTreatmentPage() {
  const content = {
    heroTitle: "Leading Hyperpigmentation Treatment in Vadodara",
    heroSubtitle: "Clinically Proven Results with Hyperpigmentation Treatment",
    
    introContent: `Uneven skin tone and pigmentation issues are among the most common concerns we see at our Vadodara clinic. Hyperpigmentation Treatment requires both expertise and patience — there are no instant fixes, but with the right approach, significant improvement is absolutely achievable.
...
Our pigmentation protocols at Prime One Hair & Skin Clinic combine multiple modalities for comprehensive results. This typically includes medical-grade topical treatments, chemical peels customized to your skin type, laser or light-based therapies, and strict sun protection guidance. We also address internal factors through nutritional recommendations and hormonal assessment when relevant.`,
    ...
    faqItems: [
          ...
          {
                "question": "How long does hyperpigmentation treatment take?",
          ...
          {
                "question": "Is hyperpigmentation treatment safe for dark skin?",
    ...
    ctaText: "Take the First Step Toward Hyperpigmentation Treatment",
    ctaDescription: "Professional hyperpigmentation treatment doesn't have to be complicated or expensive. Book your consultation and discover your options today.",
  };

  return (
    <KeywordPageTemplate
      business={business}
      keyword="hyperpigmentation-treatment-in-vadodara"
      content={content}
    />
  );
}
