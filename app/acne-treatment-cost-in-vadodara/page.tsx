...
export const metadata: Metadata = {
  title: "Professional Acne Treatment Cost in Vadodara | Prime One Clinic",
  description: "✅ Acne Treatment Cost by MD dermatologists at Prime One Clinic ✓ Proven results ✓ 10,000+ patients ✓ US FDA approved. Book consultation today!",
  keywords: "acne, treatment, cost vadodara, acne treatment cost near me, best acne treatment vadodara",
  alternates: {
    canonical: "https://skinhairvadodara.in/acne-treatment-cost-in-vadodara",
  },
  openGraph: {
    title: "Professional Acne Treatment Cost in Vadodara | Prime One Hair & Skin Clinic",
    description: "✅ Acne Treatment Cost by MD dermatologists at Prime One Clinic ✓ Proven results ✓ 10,000+ patients ✓ US FDA approved. Book consultation today!",
    url: "https://skinhairvadodara.in/acne-treatment-cost-in-vadodara",
...
export default function AcneTreatmentCostPage() {
  const content = {
    heroTitle: "Professional Acne Treatment Cost in Vadodara",
    heroSubtitle: "Personalized Acne Treatment Cost for Lasting Results",
    
    introContent: `Dealing with acne goes beyond the surface — it affects confidence, social interactions, and emotional well-being. If you're looking for acne treatment cost, you deserve a treatment approach based on medical science, not marketing promises.
...
Our treatment success rate exceeds 90% because we take a systematic approach. We combine prescription-strength topical treatments, oral medications when necessary, and clinical procedures like chemical peels, LED therapy, or laser treatments. We also address the psychological impact of acne and provide realistic timelines so you know exactly what to expect.`,
    ...
    faqItems: [
          {
                "question": "How long does acne treatment cost take to work?",
          ...
          {
                "question": "Is acne treatment cost safe for sensitive skin?",
    ...
    ctaText: "Ready to Start Your Acne Treatment Cost Journey?",
  ...
  return (
    <KeywordPageTemplate
      business={business}
      keyword="acne-treatment-cost-in-vadodara"
      content={content}
    />
  );
}
