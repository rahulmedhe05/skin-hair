...
// Real dermatology/skin care images from Unsplash
const dermaImages = {
  skinCare: "https://images.unsplash.com/photo-1570172619644-dfd03ed5d881?w=400&q=80",
  hairTreatment: "https://images.unsplash.com/photo-1522337360788-8b13dee7a37e?w=400&q=80",
  laserTreatment: "https://images.unsplash.com/photo-1612532275214-e4ca76d0e4d1?w=400&q=80",
  clinic: "https://images.unsplash.com/photo-1629909613654-28e377c37b09?w=400&q=80",
  consultation: "https://images.unsplash.com/photo-1576091160399-112ba8d25d1d?w=400&q=80",
  skinGlow: "https://images.unsplash.com/photo-1616394584738-fc6e612e71b9?w=400&q=80",
};
      ...
      <div className="border-b border-gray-700">
        <div className="container mx-auto px-4 py-10">
          <h2 className="text-2xl font-bold mb-8 text-center flex items-center justify-center gap-2">
            ...
            Skin & Hair Clinic Vadodara - All Services
            <Sparkles className="w-6 h-6 text-pink-400" />
          </h2>
      ...
      <div className="border-b border-gray-700">
        <div className="container mx-auto px-4 py-6">
          <p className="text-gray-500 text-xs text-center max-w-4xl mx-auto leading-relaxed">
            Best Skin & Hair Clinic in Vadodara offering advanced dermatology treatments including acne treatment, 
      ...
      <div className="container mx-auto px-4 py-6">
        <div className="flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <p className="text-gray-400 text-sm">
            © {new Date().getFullYear()} Skin & Hair Clinic Vadodara. All Rights Reserved.
          </p>
        </div>
      </div>
    </footer>
