...
export function SkinHairForm({ area, keyword }: SkinHairFormProps) {
  ...
  const ageGroups = ["Under 18", "18–25", "26–35", "36–50", "50+"];

  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    setIsSubmitting(true);

    let message = `💆 *SKIN & HAIR CLINIC ENQUIRY*\n\n`;
    message += `👤 *Name:* ${formData.fullName}\n`;
    message += `📱 *Mobile:* ${formData.mobile}\n`;
    message += `🎯 *Concern:* ${formData.concern}\n`;
    message += `📅 *Age Group:* ${formData.ageGroup}\n`;
    if (area) message += `📍 *Area:* ${area}\n`;
    if (keyword) message += `🔍 *Interest:* ${keyword}\n`;
    message += `\n_From: skinhairvadodara.in_`;
        ...
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-8 md:mb-12">
            ...
            <p className="text-gray-600 text-lg max-w-2xl mx-auto">
              Get expert dermatological care from Vadodara's leading skin specialists
              {area && ` in ${area}`}
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-8 items-start">
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    {concerns.map((concern) => (
                      <button
                        key={concern}
                        type="button"
                        onClick={() => setFormData({ ...formData, concern: concern })}
            ...
            <div className="space-y-6">
              <div className="bg-gradient-to-br from-pink-600 to-rose-600 rounded-2xl p-6 text-white">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-white/80 text-sm mb-2">Mon-Sat: 10 AM - 8 PM</p>
              ...
              <div className="bg-green-600 rounded-2xl p-6 text-white">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <a
                      href="https://wa.me/916353583148?text=Hi, I need skin/hair consultation"
                      target="_blank"
              ...
              <div className="bg-white rounded-2xl p-6 shadow-lg border border-gray-100">
                <h3 className="text-xl font-bold mb-4 text-pink-700">Why Choose Us?</h3>
