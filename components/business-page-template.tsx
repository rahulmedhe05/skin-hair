...
export function BusinessPageTemplate({ business, area, content }: BusinessPageTemplateProps) {
  ...
  // Handle both services and detailedServices
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <section className="relative h-64 md:h-80 overflow-hidden">
        <img
          src="/gallery/dermatology/05.webp"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[1, 2, 3, 4].map((i) => (
              <div key={i} className="relative group overflow-hidden rounded-xl shadow-lg">
                <img
                  src={`/gallery/${['skin-care', 'hair-treatment', 'dermatology', 'beauty'][i-1]}/${String(i + 4).padStart(2, '0')}.webp`}
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            ...
            <div className="space-y-4">
              <div className="relative overflow-hidden rounded-xl">
                <img
                  src="/gallery/hair-treatment/10.webp"
              ...
              <div className="relative overflow-hidden rounded-xl">
                <img
                  src="/gallery/hair-treatment/15.webp"
      ...
      <section className="py-16 md:py-20">
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-center max-w-6xl mx-auto">
            <div>
              <img
                src="/gallery/dermatology/08.webp"
            ...
            <div className="grid md:grid-cols-2 gap-8 items-center">
              ...
              <div className="grid grid-cols-2 gap-4">
                {[1, 2, 3, 4].map((i) => (
                  <img
                    key={i}
                    src={`/gallery/beauty/${String(i * 4 + 2).padStart(2, '0')}.webp`}
      ...
      <section className="relative py-20 overflow-hidden">
        <img
          src="/gallery/dermatology/15.webp"
      ...
      <InternalLinksFooter currentSlug={area} type="area" />
