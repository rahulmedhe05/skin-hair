...
import { InternalLinksFooter } from "./internal-links-footer";
...
export function KeywordPageTemplate({ business, keyword, content }: KeywordPageTemplateProps) {
  ...
  // Handle both string slug and KeywordConfig object
  const keywordSlug = typeof keyword === 'string' ? keyword : keyword.slug;
  const keywordName = typeof keyword === 'string' 
    ? keyword.replace(/-in-vadodara$/, '').replace(/-/g, ' ').replace(/\b\w/g, c => c.toUpperCase())
    : (keyword.keyword || keyword.title);
  const keywordH1 = content.heroTitle;
  const keywordMetaDescription = content.heroSubtitle;
  const aboutContent = content.introContent || content.aboutContent || '';
  const detailedServices = content.services || content.detailedServices || [];
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <BusinessHeroSlider 
        ...
        area="vadodara" 
        heroTitle={keywordH1}
        heroSubtitle={keywordMetaDescription}
        keyword={keywordName}
      />
      ...
      <section className="relative h-64 md:h-80 overflow-hidden">
        <img
          src="/gallery/dermatology/12.webp"
          ...
          <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-center max-w-6xl mx-auto">
            <div className="order-2 md:order-1">
              ...
              <div className="prose prose-lg max-w-none text-gray-700 leading-relaxed">
                <p className="whitespace-pre-line">{aboutContent}</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[1, 2, 3, 4, 5].map((i) => (
              <div key={i} className="relative group overflow-hidden rounded-xl shadow-lg">
                <img
                  src={`/gallery/${['skin-care', 'hair-treatment', 'dermatology', 'beauty', 'skin-care'][i-1]}/${String(i + 10).padStart(2, '0')}.webp`}
      ...
      <section id="services" className="py-16 md:py-20 bg-white">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
            {detailedServices.slice(0, 6).map((service, index) => (
              <div
                key={index}
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            ...
            <div className="space-y-4">
              <div className="relative overflow-hidden rounded-xl">
                <img
                  src="/gallery/hair-treatment/18.webp"
              ...
              <div className="relative overflow-hidden rounded-xl">
                <img
                  src="/gallery/hair-treatment/20.webp"
      ...
      <section className="py-16 md:py-20">
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-center max-w-6xl mx-auto">
            <div>
              <img
                src="/gallery/dermatology/18.webp"
            ...
            <div>
              <h2 className="text-3xl md:text-4xl font-bold mb-8">
                Why Choose Us for {keywordName.replace(" in Vadodara", "").replace(" Vadodara", "")}?
              </h2>
              <div className="space-y-4">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-4 max-w-6xl mx-auto mb-8">
            {vadodaraAreas.slice(0, 10).map((area, index) => (
              ...
              >
                <img
                  src={`/gallery/${['skin-care', 'hair-treatment', 'dermatology', 'beauty'][index % 4]}/${String((index % 20) + 1).padStart(2, '0')}.webp`}
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold mb-8 text-center">
              Frequently Asked Questions - {keywordName}
            </h2>
            <div className="space-y-4">
      ...
      <section className="relative py-20 overflow-hidden">
        <img
          src="/gallery/dermatology/20.webp"
          alt={`${keywordName} CTA`}
      ...
      <section id="contact" className={cn("py-16 md:py-20 bg-gradient-to-br text-white", gradientClass)}>
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <a
              href={`https://wa.me/916353583148?text=Hi, I'm interested in ${keywordName}`}
      ...
      <InternalLinksFooter currentSlug={keywordSlug} type="keyword" />

      <MegaFooter />
      
      {/* WhatsApp Floating Button */}
      <BusinessWhatsAppFloat business={business} area="vadodara" keyword={keywordName} />
    </div>
  );
}
