  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <section className="relative h-64 md:h-80 overflow-hidden">
        <img
          src={`https://picsum.photos/seed/${business.slug}-${keywordSlug}-banner/1920/600`}
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-center max-w-6xl mx-auto">
            ...
            <div className="order-1 md:order-2">
              <img
                src={`https://picsum.photos/seed/${business.slug}-${keywordSlug}-about/600/500`}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[1, 2, 3, 4, 5].map((i) => (
              <div key={i} className="relative group overflow-hidden rounded-xl shadow-lg">
                <img
                  src={`https://picsum.photos/seed/${business.slug}-${keywordSlug}-${i}/600/400`}
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            <div className="space-y-4">
              <div className="relative overflow-hidden rounded-xl">
                <img
                  src={`https://picsum.photos/seed/${keywordSlug}-before-1/600/400`}
              ...
              <div className="relative overflow-hidden rounded-xl">
                <img
                  src={`https://picsum.photos/seed/${keywordSlug}-after-1/600/400`}
            ...
            <div className="space-y-4">
              <div className="relative overflow-hidden rounded-xl">
                <img
                  src={`https://picsum.photos/seed/${keywordSlug}-before-2/600/400`}
              ...
              <div className="relative overflow-hidden rounded-xl">
                <img
                  src={`https://picsum.photos/seed/${keywordSlug}-after-2/600/400`}
      ...
      <section className="py-16 md:py-20">
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-center max-w-6xl mx-auto">
            <div>
              <img
                src={`https://picsum.photos/seed/${business.slug}-${keywordSlug}-why/600/600`}
      ...
      <section className="relative py-20 overflow-hidden">
        <img
          src={`https://picsum.photos/seed/${business.slug}-${keywordSlug}-cta/1920/600`}
          alt={`${keywordName} CTA`}
